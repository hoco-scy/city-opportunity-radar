...
if (subpages.some((content) => !content.includes('class="topbar-actions"') || !content.includes('data-admin-trigger') || !content.includes('id="admin-dialog"'))) {
  throw new Error("子页面顶栏缺少统一的管理员与收藏入口");
}
