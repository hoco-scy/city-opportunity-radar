...
首页“待确认线索”是聚合平台经过公开筛选后、尚未取得正式单位或政府原文依据的记录。管理员审核不是一键放行：页面要求填写官方公告、具体岗位、单位、地点、学历与专业要求、岗位职责、其他条件、有效期和收录理由，并确认岗位仍在有效期内或为仍有效的预公告。对于央国企与事业单位，服务端只把官方具体岗位、投递路径和专业可报证据作为发布硬门禁；岗位名称与职责的相关性仅用于排序和风险提示。
